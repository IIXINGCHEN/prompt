...
### 📋 AxiomOS 协作协议
- **最新版本**: v20.0 完整MCP工具生态集成版（生产就绪）🟢
- **v19.0**: 六大操作模式统一框架（标准版）🟡
- **Nexus OS v4.0**: Archon协议精英级自主任务执行🚀
- **专家模式框架**: 审计修复、安全渗透、文档自动化专家
- **认知核心机制**: 上下文压缩与状态管理协议
- **生产级标准**: 11大类严格的质量门禁（A-K）
...
### 🧠 AxiomOS 协议版本演进
- **v20.0**: 完整MCP工具生态集成、增强版Artifact协议、跨平台兼容性标准（🟢 最新 - 2025-09-30）
- **v19.1**: 11大类质量门禁增强版（🟡 维护模式 - 2025-09-28）
- **v19.0**: 六大操作模式统一框架（📦 已归档 - 2025-09-27）
- **v18.5**: 核心思维原则增强版（📦 已归档 - 2025-09-26）
- **v18.3**: 安全内核增强版（📦 已归档 - 2025-09-26）
- **v18.1**: 过渡版本（⚠️ 已废弃 - 请勿使用）
- **v18.0**: 统一核心指令框架（📦 已归档 - 2025-09-19）
- **v17.x**: 结构化指令系列（📦 已归档）
...
```
prompt/
├── nexus_context.md          # 🌐 全局上下文文档（单一事实来源）
...
**新用户推荐路径**：
1. 📖 阅读当前版本文档 [v20.0](docs/current/axiom-os-v20.md)
2. ⚙️ 配置 MCP 工具
3. 🎯 执行第一个任务
...
| 版本 | 状态 | 推荐用途 | 文档 |
|------|------|----------|------|
| **v20.0** | 🟢 生产就绪 | 完整MCP工具集成、Artifact协议、跨平台兼容性标准 | [axiom-os-v20.md](docs/current/axiom-os-v20.md) |
| v19.1 | 🟡 维护模式 | 企业级项目、11大类质量门禁 | [axiom-os-v19.1.md](docs/current/axiom-os-v19.1.md) |
| v19.0 | 📦 已归档 | 六大操作模式统一框架 | [axiom-os-v19.0.md](docs/current/axiom-os-v19.0.md) |
| v18.5 | 📦 已归档 | 历史参考 - 核心思维原则、审计优化模式 | [axiom-os-v18.5.md](docs/current/axiom-os-v18.5.md) |
| v18.3 | 📦 已归档 | 历史参考 - 安全内核增强 | [axiom-os-v18.3.md](docs/current/axiom-os-v18.3.md) |
