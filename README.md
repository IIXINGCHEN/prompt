...
### 🧠 AxiomOS 协议版本演进
- **v19.1**: 11大类质量门禁增强版（🟢 最新 - 2025-09-28）
- **v19.0**: 六大操作模式统一框架（🟡 维护模式 - 2025-09-27）
...
**新用户推荐路径**：
1. 📖 阅读当前版本文档 [v19.1](docs/current/axiom-os-v19.1.md)
2. ⚙️ 配置 MCP 工具
3. 🎯 执行第一个任务
...
| 版本 | 状态 | 推荐用途 | 文档 |
|------|------|----------|------|
| **v19.1** | 🟢 最新 | 企业级项目、AI代理开发、11大类质量门禁、全面增强版 | [axiom-os-v19.1.md](docs/current/axiom-os-v19.1.md) |
| v19.0 | 🟡 维护模式 | 六大操作模式统一框架、标准版 | [axiom-os-v19.0.md](docs/current/axiom-os-v19.0.md) |
